        ...
        <div class="portfolio_strict row">
          <div class="portfolio_item span3">
            ...
            <div class="portfolio_description">
              <h3><a href="portfolio_item.html">Theresa Herlihy</a></h3>
              <p>Photographer - Winchester, MA</p>
            </div>
          </div>
          <div class="portfolio_item span3">
            ...
            <div class="portfolio_description">
              <h3><a href="portfolio_item.html">Ken Stevens</a></h3>
              <p>VP Sales, Sony - Barrington, IL</p>
            </div>
          </div>
          <div class="portfolio_item span3">
          ...
          <div class="portfolio_item span3">
            ...
            <div class="portfolio_description">
              <h3><a href="portfolio_item.html">Aaron and Trecker Heating and AC</a></h3>
              <p>Lake Zurich, IL</p>
            </div>
          </div>
        </div>
